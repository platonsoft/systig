...
import com.systig.remesas.modelos.Dispositivo;
import com.systig.remesas.modelos.Usuario;
...
public class AutenticacionFilter extends AbstractAuthenticationProcessingFilter {

    public AutenticacionFilter(String url, AuthenticationManager authManager) {
