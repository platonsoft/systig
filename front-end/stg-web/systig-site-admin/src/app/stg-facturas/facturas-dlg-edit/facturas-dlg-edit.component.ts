...
@Component({
  selector: 'stg-facturas-dlg-edit',
  templateUrl: './facturas-dlg-edit.component.html',
  styleUrls: ['./facturas-dlg-edit.component.scss']
})
export class FacturasDlgEditComponent implements OnInit {
