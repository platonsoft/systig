 ...
 */
public class DatosPersonalesFragment extends Fragment implements DatePickerDialogFragment.DatePickerDialogHandler, CalendarDatePickerDialogFragment.OnDateSetListener{
    ...
    String[] TIPODOCUMENTO = {"   Cedula Identidad", "   Cedula Ciudadania", "   Cedula Extranjeria", "   Pasaporte"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            @SuppressLint("ResourceType") ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(vista.getContext(), android.R.layout.simple_spinner_dropdown_item, TIPODOCUMENTO);
            MaterialBetterSpinner materialDesignSpinner = (MaterialBetterSpinner)vista.findViewById(R.id.spinner_tipo_documento);
            materialDesignSpinner.setAdapter(arrayAdapter);
            mResultTextView = (TextView) vista.findViewById(R.id.input_fecha_nac);
