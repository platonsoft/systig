 ...
 * {@link RegisterEmpresaFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RegisterEmpresaFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RegisterEmpresaFragment extends Fragment {
    ...
    public RegisterEmpresaFragment() {
     ...
     * @return A new instance of fragment RegisterEmpresaFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static RegisterEmpresaFragment newInstance(String param1, String param2) {
        RegisterEmpresaFragment fragment = new RegisterEmpresaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_register_empresa, container, false);

        Resources res = getResources();

        String[] TIPODOCUMENTO = res.getStringArray(R.array.documentos_empresa);
        ...
        androidx.appcompat.widget.Toolbar toolbar = vista.findViewById(R.id.tool_registrar_empresa);
        toolbar.setTitle(R.string.text_button_crear_empresa);
